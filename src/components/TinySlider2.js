    ...
    <>
      ...
      >
          ...
          <div className="row align-items-center justify-content-between  mb-5">
            <div className="col-lg-5 text" data-aos="fade-up">
              <h2 className="heading mb-3">
                Beautiful villages you can explore in Bali!
              </h2>
              <p>
                Explore Bali's Enchanting Villages: Discover Penglipuran's
                serenity, Ubud's cultural charm, and more hidden gems. Each
                village offers a unique slice of Balinese tradition and
                breathtaking scenery, perfect for an authentic escape
              </p>
            </div>
            <div
        ...
        <div className="destination-slider-wrap">
          <div className="destination-slider2">
            {village.map((village) => (
              <div key={village.id} className="destination">
                <div className="thumb">
                  <img src={village.url} alt="Image" className="img-fluid" />
                </div>
                <div className="mt-4">
                  <h3>
                    <a href="#">{village.name}</a>
                  </h3>
                  <span className="meta">{village.lokasi}</span>
                </div>
              </div>
            ))}
          </div>
