    ...
    <>
      ...
      >
          ...
          <div className="row align-items-center justify-content-between mb-5">
            <div className="col-lg-5 text" data-aos="fade-up">
              <h2 className="heading mb-3">
                Beautiful forest or park you can explore in Bali!
              </h2>
              <p>
                Discover Bali's Lush Forests and Parks: Journey through the
                island's vibrant greenery, from the mystical Monkey Forest to
                the tranquil beauty of Bedugul Botanical Gardens. Each spot
                offers a refreshing retreat and a chance to connect with
                nature's wonders, ideal for adventure seekers and nature lovers
                alike.
              </p>
            </div>
            <div
        ...
        <div className="destination-slider-wrap">
          <div className="destination-slider4">
            {forest.map((forest) => (
              <div key={forest.id} className="destination">
                <div className="thumb">
                  <img src={forest.url} alt="Image" className="img-fluid" />
                </div>
                <div className="mt-4">
                  <h3>
                    <a href="#">{forest.name}</a>
                  </h3>
                  <span className="meta">{forest.lokasi}</span>
                </div>
              </div>
            ))}
          </div>
